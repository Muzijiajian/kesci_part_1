...
#google_model = '/home/lord/PycharmProjects/Kesci/model/google_4437net_iter_200000.caffemodel'
#google_deploy = '/home/lord/caffe-master/Workspace/Kesci/googleNet/bvlc_googlenet_bottomup_4437_deploy.prototxt'
#cnn = CNN(model=google_model, deploy=google_deploy, width=224, height=224)
AlexNet_model = '/home/lord/PycharmProjects/Kesci/model/self_model_iter_200000.caffemodel'
AlexNet_deploy = '/home/lord/caffe-master/Workspace/Kesci/zju/deploy.prototxt'
cnn = CNN(model=AlexNet_model, deploy=AlexNet_deploy, width=224, height=224)
feat_path = '/home/lord/PycharmProjects/Kesci/set5/one_feats.npy'

image_lists = []
image_name_cut = []
setone_image_path = '/home/lord/Downloads/kescitest/Testset_7'
# setone_image_path = '/home/lord/Downloads/kescitest/save_crop'
...
if not os.path.exists(feat_path):
    feats = cnn.get_features(image_lists, layers='fc8_', layer_sizes=[12])
...
for i in xrange(soft_feats.shape[0]):
    ...
    # print soft_feats[i]
    count += 1
    if count == soft_feats.shape[0]:
        break

# 将对应数据写入文本
with open('/home/lord/PycharmProjects/Kesci/set5/alex_pred.txt', 'w') as fp:
    print len(image_name_cut), len(label_1_lists), len(prob_1_lists), len(label_2_lists), len(prob_2_lists)
    for i in xrange(len(label_1_lists)):
