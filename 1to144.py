...
def process(image_dir):
    ...
    if img.shape[0] > 352 or img.shape[1] > 352:
        ...
        crop_images_3 = []
        global crop_images_3
        # crop_images_3_part2 = []
        crop_dims = (224, 224)
        for image in crop_images_2:
            crop_images_3.append(oversmaple(image, crop_dims))
        ...
        for image_tuple in crop_images_3:
    ...
    return avg_image, crop_images_3, flag
...
if __name__ == '__main__':
    ...
    images_dir = '/home/lord/Downloads/kescitest/Testset_7'
    # images_dir = '/home/lord/Downloads/kescitest/test_crop'
    save_images_dir = '/home/lord/Downloads/kescitest/crops/crops_set7'
