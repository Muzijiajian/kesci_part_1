...
feat_path = '/home/lord/PycharmProjects/Kesci/set6/one_feats.npy'
cnn = CNN(model=google_model, deploy=google_deploy, width=224, height=224)

image_lists = []
image_name_cut = []
setone_image_path = '/home/lord/Downloads/kescitest/Testset_6'
...
if not os.path.exists(feat_path):
    feats = cnn.get_features(image_lists, layers='fc7', layer_sizes=[12])
